      ...
      <div class="page-header d-print-none">
        <div class="container-xl">
          <div class="row g-2 align-items-center">
            <div class="col">
              <h2 class="page-title text-primary">Lihat Peran</h2>
            </div>
          </div>
        </div>
      </div>
              ...
              <form method="POST" action="{{ route('casts.update', $cast->id) }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control border-primary" id="name" name="name"
                    placeholder="Masukkan Nama" value="{{ old('name', $cast->name) }}" required>
                </div>

                <div class="mb-3">
                  <label for="age" class="form-label">Usia</label>
                  <input type="text" class="form-control border-primary" id="age" name="age" placeholder="Masukkan Usia"
                    value="{{ old('age', $cast->age) }}" required>
                </div>

                <div class="mb-3">
                  <label for="biodata" class="form-label">Biodata</label>
                  <textarea class="form-control border-primary" id="biodata" name="biodata" rows="3"
                    placeholder="Masukkan Biodata" required>{{ old('biodata', $cast->biodata) }}</textarea>
                </div>

                <div class="mb-3">
                  <label for="avatar" class="form-label">Avatar</label>
                  <input type="file" class="form-control border-primary" id="avatar" name="avatar" accept="image/*">
                </div>
